  ...
  <div class="container mx-auto px-4 py-8">
    <div class="mb-8">
      <div class="flex flex-wrap items-center justify-between gap-4 mb-2">
        <UiTypography as="h1" variant="h1-upper" class="text-primary">
        ...
        <div class="flex items-center gap-3">
          <div class="flex items-center gap-2">
            ...
            <UiTypography variant="text-sm-normal">Норма</UiTypography>
          </div>
          <div class="flex items-center gap-2">
            <Badge severity="warning" />
            <UiTypography variant="text-sm-normal">Предупреждение</UiTypography>
          </div>
          <div class="flex items-center gap-2">
            <Badge severity="danger" />
            <UiTypography variant="text-sm-normal">Критично</UiTypography>
          </div>
        </div>
      </div>
      
      <UiTypography variant="text-base-normal" class="text-surface-600 mb-4">
      ...
      <div class="flex flex-wrap items-center gap-4 bg-surface-50 p-4 rounded-lg">
        <div class="flex items-center gap-2">
          <i class="pi pi-sync text-primary-500 animate-spin" style="font-size: 1rem"/>
          <UiTypography variant="text-sm-semibold">
            Автообновление:
          </UiTypography>
          <UiTypography variant="text-sm-normal" class="text-surface-700">
            каждые 5 секунд
          </UiTypography>
        </div>
        
        <div class="flex items-center gap-2">
          <i class="pi pi-clock text-surface-500" style="font-size: 1rem"/>
          <UiTypography variant="text-sm-semibold">
    ...
    <div v-else-if="error" class="bg-danger-50 p-6 rounded-lg text-center">
      <i class="pi pi-exclamation-circle text-danger-500 mx-auto mb-3" style="font-size: 2rem"/>
      <UiTypography variant="text-sm-normal" class="text-danger-700 mb-2">
        Ошибка загрузки данных
      </UiTypography>
      <UiTypography variant="text-base-normal" class="text-surface-700 mb-4">
    ...
    <div class="mt-10 pt-6 border-t border-surface-200">
      <UiTypography variant="h2-upper" class="mb-4">
        О системе мониторинга
      </UiTypography>
      <UiTypography variant="text-base-normal" class="text-surface-700">
